...
public class AttendenceTracking extends School{
    ...
    public void attendenceOfStudents(String name, String ID, String status) {
        day = gc.get(GregorianCalendar.DAY_OF_MONTH); // Assigning the current date
        month = gc.get(GregorianCalendar.MONTH) + 1; // Adding 1 as months are 0-indexed
        year = gc.get(GregorianCalendar.YEAR); // Getting the current year
